public class Motor extends Motorvoertuig implements Verhuurbaar, Rijbaar {
    public int aantalwielen = 2;
    private String naam;
    ...
    public Motor(String naam, boolean verhuurbaar, boolean rijbaar){
        this.naam = naam;
    ...
    public void rijden(){
        System.out.println(naam + " is aan het rijden.");
    }
